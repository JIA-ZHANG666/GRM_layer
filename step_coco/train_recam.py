...
def run(args):
    ...
    train_data_loader = DataLoader(train_dataset, batch_size=args.recam_batch_size,shuffle=True, num_workers=args.num_workers, pin_memory=False, drop_last=True)
    ...
    val_data_loader = DataLoader(val_dataset, batch_size=args.recam_batch_size,shuffle=False, num_workers=args.num_workers, pin_memory=False, drop_last=True)
    ...
    for ep in range(args.recam_num_epoches):
        ...
        for step, pack in enumerate(train_data_loader):
            ...
            #loss_ce = recam_predictor(cam,label)
