...
def DeepLabV2_ResNet101_MSC_SGR(n_classes, input_feature_channels, visual_feature_channels,
    num_symbol_node,fasttest_embeddings, fasttest_dim, graph_adj_mat, training=True):
    return MSC(
        base=DeepLabV2_SGR(
            n_classes=n_classes, n_blocks=[3, 4, 23, 3], atrous_rates=[6, 12, 18, 24],
            input_feature_channels=input_feature_channels,
            visual_feature_channels=visual_feature_channels,
...
##########################
def DeepLabV2_ResNet101_MSC_SGR_2(n_classes, input_feature_channels, visual_feature_channels,
    num_symbol_node,fasttest_embeddings, fasttest_dim, graph_adj_mat, training=True):
    return MSC(
        base=DeepLabV2_SGR_2(n_classes=n_classes,
                           n_blocks=[3,4,23,3],
