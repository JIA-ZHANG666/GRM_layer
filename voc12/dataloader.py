...
class VOC12ClassificationDataset(VOC12ImageDataset):
    ...
    def __init__(self, img_name_list_path, voc12_root, inp_name,
                 resize_long=None, rescale=None, img_normal=TorchvisionNormalize(), hor_flip=False,
    ...
    def __getitem__(self, idx):
        ...
        #out['inp'] = self.inp
        out = {'name': name_str, 'img': img,"inp": self.inp,
               "label": torch.from_numpy(self.label_list[idx])}
...
class VOC12ClassificationDatasetMSF(VOC12ClassificationDataset):
    ...
    def __init__(self, img_name_list_path, voc12_root, inp_name, img_normal=TorchvisionNormalize(), scales=(1.0,)):
        self.scales = scales

        super().__init__(img_name_list_path, voc12_root, inp_name, img_normal=img_normal)
        self.scales = scales
