...
class COCOClassificationDataset(data.Dataset):
    def __init__(self, image_dir, anno_path, labels_path=None, inp_name=None,resize_long=None, rescale=None, img_normal=TorchvisionNormalize(), hor_flip=False,
    ...
    def __getitem__(self, index):
        ...
        return {'name': name, 'img': img,'inp':self.inp, 'label':self.labels[index] }
    
    def __len__(self):
        return len(self.coco)

class COCOClassificationDatasetMSF(COCOClassificationDataset):
    def __init__(self, image_dir, anno_path, labels_path=None, inp_name=None, img_normal=TorchvisionNormalize(), hor_flip=False,scales=(1.0,)):
        self.scales = scales
        super().__init__(image_dir, anno_path, labels_path,inp_name, img_normal, hor_flip)
