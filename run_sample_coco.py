...
if __name__ == '__main__':
    ...
    parser.add_argument("--inp_name", default="./data/coco/coco_glove_word2vec.pkl", type=str)
    # ReCAM
    ...
    parser.add_argument("--recam_batch_size", default=2, type=int)
    ...
    # Output Path
    parser.add_argument("--work_space", default="result_default1", type=str) # set your path
